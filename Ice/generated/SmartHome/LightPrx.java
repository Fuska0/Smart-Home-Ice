...
public interface LightPrx extends DevicePrx
{
        ...
        throws DeviceIsOFF
    {
        try
        {
            return _iceI_getRGBAsync(context, true).waitForResponseOrUserEx();
        }
        catch(DeviceIsOFF ex)
        {
            throw ex;
    ...
    {
        com.zeroc.IceInternal.OutgoingAsync<RGB> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getRGB", null, sync, _iceE_getRGB);
    ...
    /** @hidden */
    static final Class<?>[] _iceE_getRGB =
    {
        DeviceIsOFF.class
    };
